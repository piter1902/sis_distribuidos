...
echo 'Node.connect(:"repo@127.0.0.1"); Process.register(self(),'$3'); c "repositorio.exs"; c "repoPruebas.exs"; Process.sleep(1000);Pruebas.init_prueba('$4', '$5', '$7', {:repo,:"repo@127.0.0.1"}, '$9')' | iex --name $1'@'$2 --cookie $6 2>/dev/null
